...
Original file is located at
    https://colab.research.google.com/drive/1muwkcWIvBxsJprD0tnkJWcazk-lMc6Ng
...
#gol_df = data.DataReader(name = 'GOLL4.SA', data_source='yahoo', start='2014-01-01')
...
# ATUALIZAÇÃO OUT-2024, para detalhes:
...
for acao in acoes:
  #acoes_df[acao] = data.DataReader(acao, data_source='yahoo', start='2024-01-01')['Close']
